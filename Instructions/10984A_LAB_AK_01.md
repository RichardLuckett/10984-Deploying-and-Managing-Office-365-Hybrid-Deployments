...
8. In the **Text** field, enter **MS=ms*XXXXXXXX*** that you recorded in Step 3 and then select **OK**.
9. In the **Resource Record Type** dialog box, select **Done**.
10. Right-click **Adatum*yyxxxxx*.hostdomain.com**, and then select **New Host \(A or AAAA\)**.
